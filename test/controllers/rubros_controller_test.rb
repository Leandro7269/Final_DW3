...
class RubrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rubro" do
    assert_difference('Rubro.count') do
      post rubros_url, params: { rubro: { nombre: @rubro.nombre, perecedero: @rubro.perecedero } }
    end
  ...
  test "should update rubro" do
    patch rubro_url(@rubro), params: { rubro: { nombre: @rubro.nombre, perecedero: @rubro.perecedero } }
